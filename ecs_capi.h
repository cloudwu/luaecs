...
void * entity_add_sibling_(struct entity_world *w, int cid, int index, int silbling_id, const void *buffer, void *L, int world_index);
int entity_new_(struct entity_world *w, int cid, const void *buffer, void *L, int world_index);
void entity_remove_(struct entity_world *w, int cid, int index, void *L, int world_index);
void entity_enable_tag_(struct entity_world *w, int cid, int index, int tag_id, void *L, int world_index);
